---
title: "神经元与神经网络"
seoTitle: "祁新世界观 神经元网络是一个选择系统"
seoDescription: "祁新世界观 神经元网络是一个选择系统"
datePublished: Tue May 27 2025 07:07:15 GMT+0000 (Coordinated Universal Time)
cuid: cmb66bojm003c09l7hi6qg0dl
slug: neuralnetwork
cover: https://cdn.hashnode.com/res/hashnode/image/stock/unsplash/wDH7c3pXkpY/upload/7f6b4b55f05b9eb2cb20375440fd71fb.jpeg
tags: 56wb5paw5liw55wm6kec

---

大脑中，神经元是最基本的计算单元，神经元传递的是电信号。大脑约有860亿神经元，理解了神经元的运作及其互联，也就知道了大脑运作的底层逻辑。

此时，我是以建模的思路来铺陈这些内容的，并非复述生物医学领域对大脑与神经元的发现，而是以为大脑建模为目的，挑选那些对模型最为关键的信息来陈述，而且尽量简化，以求达到信息简要，符合逻辑，能够理解的程度。

本节的很多内容来自《得到》中王立铭老师的 “[脑科学五十讲](https://www.igetget.com/course/%E7%8E%8B%E7%AB%8B%E9%93%AD%C2%B7%E8%84%91%E7%A7%91%E5%AD%A650%E8%AE%B2?param=DkBf54iWfG0&token=D75xge6dAqWVpPasx2VYRzmGO14jPZ)” 课程。这个系列对于大脑的基本机制的介绍非常简明清晰的，胜过许多专业的书籍。本节图片，除了有标注的之外，都来自该讲义。
...
![](https://cdn.hashnode.com/res/hashnode/image/upload/v1748313158206/a400d671-ca9b-4586-8797-b46f51538b74.png align="center")
...
![](https://cdn.hashnode.com/res/hashnode/image/upload/v1748313204145/babeb900-63b0-4465-94f4-20bb8f43970e.png align="center")
...
![](https://cdn.hashnode.com/res/hashnode/image/upload/v1748313315735/783c8e7e-d96c-4ec9-9f3f-8c91e1c2bef9.png align="center")
...
![](https://cdn.hashnode.com/res/hashnode/image/upload/v1748313449902/e3cddf32-3895-4a5e-890f-de1133801074.png align="center")
...
![](https://cdn.hashnode.com/res/hashnode/image/upload/v1748313670481/5017c35c-17bc-4548-b426-0e790876b936.png align="center")
...
![](https://cdn.hashnode.com/res/hashnode/image/upload/v1748313712703/e8e769e9-c932-4326-ba55-1ca324084176.png align="center")
...
![](https://cdn.hashnode.com/res/hashnode/image/upload/v1748313784147/bafb2ace-7250-4b72-8a1a-20a766b3ea73.png align="center")
...
![](https://cdn.hashnode.com/res/hashnode/image/upload/v1748314300432/65ae38b4-a88e-46b2-9708-e2fdc4272ebc.png align="center")
...
<div data-node-type="callout-text">经过了神经递质受体、突触、树枝、树干这几个阶段的整合，整个神经元要么激活，要么沉默。</div>
</div>
...
![](https://cdn.hashnode.com/res/hashnode/image/upload/v1748314522751/1c11f0f8-2bc7-4277-adf2-981df573799e.png align="center")
...
![](https://cdn.hashnode.com/res/hashnode/image/upload/v1748314555026/a1b75479-722a-4b86-9b9a-ad41e35477cd.png align="center")
...
![](https://cdn.hashnode.com/res/hashnode/image/upload/v1748314702845/bcd740f1-b5b2-4521-a586-9c5b730f7c17.png align="left")
...
* \\(A_i\\) 为神经元的多个输入，神经元有多个突触接受多个上级神经元的输入，每一个突触可以视作一个 \\(A_i\\) 。
...
<div data-node-type="callout">
<div data-node-type="callout-emoji">💡</div>
<div data-node-type="callout-text">在数学意义上，一个神经元的计算能力可以简化描述为，对于输入的一个n维向量，神经元可以判断它是位于向量空间的某个基准平面的左侧还是右侧。因此，单个神经元可以视作一个选择器。对于任何输入，它都可以判断出该输入是不是符合某种内定的筛选标准。神经元的本质是进行 <strong>选择</strong>。</div>
</div>
...
![](https://cdn.hashnode.com/res/hashnode/image/upload/v1748327240029/731914fa-4fda-4e4e-8100-1ee180084c21.png align="center")
...
<div data-node-type="callout">
<div data-node-type="callout-emoji">💡</div>
<div data-node-type="callout-text">从婴儿到成人的大脑发育，是神经元从单点互联为随机网络，再修剪为神经链路的过程。</div>
</div>
...
![](https://cdn.hashnode.com/res/hashnode/image/upload/v1748327392164/73fcd184-fb7c-4e60-803b-b129072bd123.png align="center")
...
![](https://cdn.hashnode.com/res/hashnode/image/upload/v1748327419354/23f4839e-cdd3-4d8b-9a80-4acbe96abdc9.png align="center")
...
![](https://cdn.hashnode.com/res/hashnode/image/upload/v1748327495216/1e1b34be-98b6-404f-847c-3ac82f2dbf68.png align="center")
...
![](https://cdn.hashnode.com/res/hashnode/image/upload/v1748327892227/dc987f52-3a58-41d6-9a2b-42effad44a1a.png align="center")
...
<div data-node-type="callout">
<div data-node-type="callout-emoji">💡</div>
<div data-node-type="callout-text">这其中不存在什么逻辑推理，纯粹是一个千头万绪的信号之发散、震荡与收敛过程，它主导了神经元网络的时空协调，使之最终成为一个整体，达成状态转换。在信号折返过程中，各种感觉信号得以整合。比如，事物的震动、气味、颜色、轮廓、纹理、运动、方向和速度等等特征就能融合到一起了，成为质感或者更高层级的概念与事件。这样，功能各异的多个脑区针对各种属性的神经活动就能互相融合，而无需一个上级来指挥与协调。</div>
</div>
...
![](https://cdn.hashnode.com/res/hashnode/image/upload/v1748329288108/83ddef93-bbbc-4d00-8303-6129dd6e315f.png align="center")