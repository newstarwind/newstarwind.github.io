---
title: "质感"
seoTitle: "祁新世界观：质感与人脑中的内部模型"
seoDescription: "祁新世界观：探讨大脑的解码能力及质感，揭示人类感知、表征与内部模型的构建对现实理解的影响。"
datePublished: Tue Jun 03 2025 08:11:19 GMT+0000 (Coordinated Universal Time)
cuid: cmbg8p1bo001209l1ckz7hfil
slug: qualia
cover: https://cdn.hashnode.com/res/hashnode/image/stock/unsplash/hezNrE5QEa8/upload/2dfacea75f651e7a51d0b5d30ab6a754.jpeg
...
![](https://cdn.hashnode.com/res/hashnode/image/upload/v1748935480594/8fa7d28f-c00c-4d27-8fa8-ffc102a6cd2c.png align="center")
...
人脑是生存工具，需要在有限时间内即时作出反应，帮助人类应对各种意外情况。它的体积与能耗是有限的，处理时间是有限的。现实世界越来越复杂，物理世界则在本质上是 [**不可知的**](https://dq.hashnode.dev/universeunknown) 。所以，人脑不能对客观世界照单全收，那样会造成信息过载，处理延迟。人脑是按照人的需要，对信息进行采样，提取特征值，然后基于这些特征值来构建内部模型，用内部模型来模拟客观世界，并做出预测。这是是生物演化的结果，是人脑的局限，也是它高明的地方。
...
![](https://cdn.hashnode.com/res/hashnode/image/upload/v1748935676785/cf3dd2de-b8c1-4b29-a97d-7e860f1dc8a1.png align="center")
...
![](https://cdn.hashnode.com/res/hashnode/image/upload/v1748935712194/b275a98f-19da-4cb5-a3e9-24195ced13d5.png align="center")
...
![](https://cdn.hashnode.com/res/hashnode/image/upload/v1748935776245/af725221-8821-4f29-8c0d-ddbbb6a63ca8.png align="center")
...
![](https://cdn.hashnode.com/res/hashnode/image/upload/v1748935864079/9dd96569-4976-408d-8877-08ee1f9f7093.png align="center")
...
![](https://cdn.hashnode.com/res/hashnode/image/upload/v1748935897088/6bd498ff-7eac-4163-a815-b106c0dbdfa4.png align="center")
...
![](https://cdn.hashnode.com/res/hashnode/image/upload/v1748935921137/7f8d798a-779f-4b1f-ac26-e48167e24908.png align="center")

图片来自维基百科。

下面的图片中，我们会认为白色十字交叉处有隐隐约约的黑色阴影，实际上并没有。

![](https://cdn.hashnode.com/res/hashnode/image/upload/v1748935943665/437bb79c-51c1-4904-aa8f-4cc7df972ad4.png align="center")
...
<div data-node-type="callout-text">我们感知的现实，是大脑中构建的内部模型。它是一套按照我们的兴趣来定制与编排的，只为我们自己播放的，无法关闭的电视节目。</div>
</div>
...
![](https://cdn.hashnode.com/res/hashnode/image/upload/v1748936063169/e2bc5203-3532-4bf6-8eca-0599e11d13fc.png align="center")
...
表征是大脑构建内部模型的一个步骤。但是，在认知科学中，从表征到我们的真实感受中间，存在一个难以跨越的鸿沟，被称为 [**困难问题**](https://zh.wikipedia.org/wiki/%E5%9B%B0%E9%9A%BE%E9%97%AE%E9%A2%98)。
...
![](https://cdn.hashnode.com/res/hashnode/image/upload/v1748936219581/2da30242-c367-49d7-be76-8dabb430f679.png align="center")
...
![](https://cdn.hashnode.com/res/hashnode/image/upload/v1748936241763/f5db4635-4f84-4f46-bfa5-10ca1ac0c15b.png align="center")
...
![](https://cdn.hashnode.com/res/hashnode/image/upload/v1748936263030/6bb4bf5f-1056-4004-a0f6-a4b5a47d98a1.png align="center")
...
![](https://cdn.hashnode.com/res/hashnode/image/upload/v1748936366317/84c34a93-a9e5-4925-93d4-09178cd45e7d.png align="center")
...
![](https://cdn.hashnode.com/res/hashnode/image/upload/v1748936403626/4dccca85-798c-4ec6-bd78-0ae97fcfba1e.png align="center")
...
![](https://cdn.hashnode.com/res/hashnode/image/upload/v1748936478193/39a81161-21b7-401b-ba6e-04435324ed56.png align="center")
...
<div data-node-type="callout">
<div data-node-type="callout-emoji">💡</div>
<div data-node-type="callout-text">海鞘为什么这么让我感动？它是一个绝妙的隐喻，指出了人群中一部分人的生存状态。他们是动物，但过着植物一般的生活。</div>
</div>
...
![](https://cdn.hashnode.com/res/hashnode/image/upload/v1748936621342/df138aa0-6362-469f-81c5-aca88e3f21df.png align="center")
...
![](https://cdn.hashnode.com/res/hashnode/image/upload/v1748936721300/871b394c-7ac6-43ae-ab17-9e938d155f0f.png align="center")

![](https://cdn.hashnode.com/res/hashnode/image/upload/v1748936743754/038ff973-5cc9-4b94-9b02-2c0cffada95a.png align="center")
...
我在谈论种群演化时，总结出了 [**变化与选择**](https://dq.hashnode.dev/series/evolution) 的规律，变化就是内置的可选项，选择就是适应环境而对可选项进行筛选。物种演化的可选项被种群的基因池决定，而大脑中的大部分可选项，也一样来源于基因遗传。
...
![](https://cdn.hashnode.com/res/hashnode/image/upload/v1748937028858/64ac92a3-86da-4261-ae6b-92bd1e2b5cf2.png align="center")
...
经过了质感的铺垫，我们终于可以碰触到大脑中最为精妙的部分——[**意识**](https://zh.wikipedia.org/wiki/%E6%84%8F%E8%AF%86)。